<template>
  <div id="ProductsDatails" class="datails-slide">
    ...
    <swiper-list ref="swiper" :cureindex="cureindex" :Pro="Pro"></swiper-list>
    ...
    <products-datails class="prodatails" ref="Imgs" :Pro="Pro" :cureindex="cureindex"></products-datails>
...
<script>
  ...
  import SwiperList from '@/components/Public/p3/ProductsDatails/views/SwiperList'
  import Ship from '@/components/Public/p3/ProductsDatails/views/Ship'
  import Comment from '@/components/Public/p3/ProductsDatails/views/Comment'
  import Selects from '@/components/Public/p3/ProductsDatails/views/Selects'
  import Bottom from '@/components/Public/p3/ProductsDatails/views/Bottom'
  import ProductsDatails from '@/components/Public/p3/ProductsDatails/views/ProductsDatails'
  import DataHeader from '@/components/Public/p3/DataHeader'
  ...
  export default{
    ...
    mounted(){
      ...
      //datalist页面的渲染
      GetDatas().then(res =>{
        var Index = parseInt(this.cureindex) ;
        var ret = res.data.ret ;
        if(ret == true){
          this.Pro = res.data.data.cure[Index] ;
        }else{
    ...
    methods:{
      ...
      addCart(){
        const products_3 = {} ;
        products_3.id = this.Pro.id ;
        products_3.image = this.Pro.imgUrl ;
